...
sleep 99
if !GetKeyState(key_shoot) or burst
{
DllCall("mouse_event", uint, 4, int, 0, int, 0, uint, 0, int, 0)
break
}
...
if ak{
    ...
    tap_time := 375 ; default
    crouch_tap_time := 300 ;default
}
...
While GetKeyState("MButton", "P"){
	...
	Sleep crouch_tap_time ;milliseconds

	} else {

        Sleep tap_time	;  milliseconds
	}
...
*~$RButton::
SoundPlay, %A_ScriptDir%\13.mp3
burst := burst ? false : true ;toggle burst
return